  ...
  return (
    <LayerGroup>
      ...
      <Circle 
        center={[28.63, 77.20]} 
        radius={3000} 
        pathOptions={{ color: '#00f2ff', fillColor: '#00f2ff', fillOpacity: 0.02, weight: 1, dashArray: '10, 20' }} 
      />
    </LayerGroup>
  );
};

const TacticalMap = ({ teams, missions, sosReports, selectedTeam, onTeamSelect }) => {
